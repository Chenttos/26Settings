...
taller rows, sentence-case section headers, 29pt squircle glyphs with a soft
gloss, a translucent navigation bar with a circular glass back button, a pill
search field, an account/quick-glance banner on the root pane, and rounded
glass notification banners in SpringBoard.
...
- `Tweak/MLYStyle.{h,m}` — shared geometry/tint/gloss helpers
